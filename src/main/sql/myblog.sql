...
CREATE TABLE `t_contents` (
                              ...
                              `type` varchar(16) DEFAULT NULL,
                              `status` varchar(16) DEFAULT NULL,
                              `fmyType` varchar(16) DEFAULT NULL,
                              `tags` varchar(200) DEFAULT NULL,
                              `categories` varchar(200) DEFAULT NULL,
                              `hits` int(10) DEFAULT NULL,
                              `commentsNum` int(10) DEFAULT NULL,
                              `allowComment` int(10) DEFAULT NULL,
                              `allowPing` int(10) DEFAULT NULL,
                              `allowFeed` int(10) DEFAULT NULL,
                              PRIMARY KEY (`cid`)
...
-- ----------------------------
BEGIN;
INSERT INTO `t_options` VALUES ('article_image_location', 'myblog/article/image/', null);
INSERT INTO `t_options` VALUES ('other_image_location', 'myblog/other/image/', null);
INSERT INTO `t_options` VALUES ('qiniu_accesskey', '', null);
INSERT INTO `t_options` VALUES ('qiniu_bucket', '', null);
INSERT INTO `t_options` VALUES ('qiniu_domain', 'image.myblog.com/', null);
INSERT INTO `t_options` VALUES ('qiniu_secretkey', '', null);
INSERT INTO `t_options` VALUES ('site_description', '专注Java后端技术、SpringBoot、SpringCloud、微服务架构、高可用架构、中间件使用、系统监控等相关的研究与知识分享。', null);
INSERT INTO `t_options` VALUES ('site_keywords', 'liyuehui,springboot,springcloud,java,并发编程,jvm,架构,技术分享,技术干货,系统架构,个人网站,生活随笔,开发者,编程,代码,开源,IT网站,IT技术博客', null);
INSERT INTO `t_options` VALUES ('site_record', '京ICP备18029773号', null);
INSERT INTO `t_options` VALUES ('site_theme', 'default', null);
INSERT INTO `t_options` VALUES ('site_title', 'myblog', null);
INSERT INTO `t_options` VALUES ('site_url', 'https://www.myblog.com', null);
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user` VALUES ('1', 'admin', 'f6a8ee259509367ead29a246a5fdaea7', '1927457049@qq.com', null, '老李', '1525759224', null, '1525759237', null);
COMMIT;
