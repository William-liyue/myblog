...
public interface IContentService {
     ...
     * Author:70kg
     * Param [page, limit]
     * Return com.github.pagehelper.PageInfo<Contents>
    ...
    default PageInfo<Contents> getArticlesByConditions(String article, String tag, String status, int page, int limit) {
        return null;
    }
